...
def ploting_LineartoLinear(Hash_list, Ac_list, input_file_name, reinvestment_ratio_list, HorC) :
    if HorC == 0:
        output_file_name = input_file_name[80:104] + 't1.png'
    else:
        output_file_name = input_file_name[90:114] + 't1.png'
...
def ploting_LineartoLog(Hash_list, Ac_list, input_file_name, reinvestment_ratio_list, HorC):
    if HorC == 0:
        output_file_name = input_file_name[80:104] + 't2.png'
    else:
        output_file_name = input_file_name[90:114] + 't2.png'
...
def ploting_LogtoLog(Hash_list, Ac_list, input_file_name, reinvestment_ratio_list, HorC):
    if HorC == 0:
        output_file_name = input_file_name[80:104] + 't3.png'
    else:
        output_file_name = input_file_name[90:114] + 't3.png'
